...
public class EnvironmentVariables {
	...
	public static boolean FRACTIONAL_SEGMENTS_ON =  true;
	...
	public static boolean INTERSECTION_TRAVERSAL_ON = true;
	/** Standard measure of the cost of traversing an intersection, in miles. 
	 * Based on an average wait time of HALF A MINUTE at each intersection.
	 * HALF A MINUTE wait time calculated for an average speed of 2 minutes-per-mile. 
	 * ( 30 MPH , .25 miles-per-minute) */
	...
	public static boolean STREET_CLASSIFICATION_ON = true;
     ...
     *  optimization will be active if either intersection traversal or street classification is 
     *  turned on. */
	 ...
	 * exponentially increased.  This PathFinding optimization will be active if either 
	 * intersection traversal or street classification is turned on. */
	public static double MAXIMUM_BUFFER_DISTANCE = 1.0;
