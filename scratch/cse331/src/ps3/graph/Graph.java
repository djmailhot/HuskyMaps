...
public class Graph<E>{
	...
	/**
	 * Get whether the specified node exists in the graph
	...
	/**
	 * Get whether an edge from the specified parent to the specified child exists
	 *  in the graph.
	...
	/**
	 * Get the current set of nodes in the graph
	...
	/**
	 * Get the set of children for the specified node
