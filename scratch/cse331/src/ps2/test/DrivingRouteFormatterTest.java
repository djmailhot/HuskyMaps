...
public class DrivingRouteFormatterTest extends TestCase {
    ...
    public void testShortDirections() throws IOException {
        ...
        assertEquals("Turn left onto Penny Lane and go 4.7 miles.\n",
                     mDirections.computeDirections(mShortRoute, 180));
        assertEquals("Turn right onto Penny Lane and go 4.7 miles.\n",
                     mDirections.computeDirections(mShortRoute, 0));

        assertEquals("Turn slight left onto Penny Lane and go 4.7 miles.\n",
                     mDirections.computeDirections(mShortRoute, 100));
        assertEquals("Turn slight right onto Penny Lane and go 4.7 miles.\n",
                     mDirections.computeDirections(mShortRoute, 80));

        assertEquals("Continue onto Penny Lane and go 4.7 miles.\n",
                     mDirections.computeDirections(mShortRoute, 99));
        assertEquals("Continue onto Penny Lane and go 4.7 miles.\n",
                     mDirections.computeDirections(mShortRoute, 81));

        assertEquals("Turn sharp right onto Penny Lane and go 4.7 miles.\n",
                     mDirections.computeDirections(mShortRoute, 330));
        assertEquals("Turn sharp left onto Penny Lane and go 4.7 miles.\n",
                     mDirections.computeDirections(mShortRoute, 231));

        assertEquals("U-turn onto Penny Lane and go 4.7 miles.\n",
    ...
    public void testTurning() {
        ...
        mShortRoute = new Route(new GeoSegment(mName,
                                               new GeoPoint(0,0),
                                               new GeoPoint(-oneUnit,39510)));
        assertEquals("Turn slight left onto Penny Lane and go 7.1 miles.\n",
                     mDirections.computeDirections(mShortRoute, 180));
        ...
        mShortRoute = new Route(new GeoSegment(mName,
                                               new GeoPoint(0,0),
                                               new GeoPoint(-oneUnit,-39510)));
        assertEquals("Turn slight right onto Penny Lane and go 7.1 miles.\n",
                     mDirections.computeDirections(mShortRoute, 180));
        ...
        mShortRoute = new Route(new GeoSegment(mName,
                                               new GeoPoint(0,0),
                                               new GeoPoint(oneUnit,39510)));
        assertEquals("Turn sharp left onto Penny Lane and go 7.1 miles.\n",
                     mDirections.computeDirections(mShortRoute, 180));
        ...
        mShortRoute = new Route(new GeoSegment(mName,
                                               new GeoPoint(0,0),
                                               new GeoPoint(oneUnit,-39510)));
        assertEquals("Turn sharp right onto Penny Lane and go 7.1 miles.\n",
                     mDirections.computeDirections(mShortRoute, 180));

        // U-turn (on the right side, 179.5 degree)
        mShortRoute = new Route(new GeoSegment(mName,
                                               new GeoPoint(0,0),
                                               new GeoPoint(-oneUnit,1293)));
        assertEquals("U-turn onto Penny Lane and go 6.9 miles.\n",
                     mDirections.computeDirections(mShortRoute, 0));
    ...
    public void testRepeatedSegment() {
        ...
        assertEquals("Turn left onto Penny Lane and go 9.3 miles.\n",
    ...
    public void testLongRoute() {
        ...
        String directions =
            "Turn left onto Penny Lane and go 9.3 miles." + "\n" +
            "Turn left onto Abby Road and go 13.8 miles." + "\n" +
            "Continue onto Strawberry Fields and go 13.8 miles." + "\n" +
            "Turn right onto Octopus's Garden and go 9.3 miles." + "\n" +
            "Turn slight left onto Norwegian Wood and go 50.0 miles." + "\n" +
            "U-turn onto Yellow Submarine and go 83.3 miles." + "\n"
            ;
    ...
    public void testRepeatedRoute() {
        ...
        String directions =
            ...
            "Turn left onto Abby Road and go 13.8 miles." + "\n" +
            "Continue onto Strawberry Fields and go 13.8 miles." + "\n" +
            "Turn sharp right onto Octopus's Garden and go 19.9 miles."+ "\n" +
            "Turn slight left onto Norwegian Wood and go 50.0 miles." + "\n" +
            "U-turn onto Yellow Submarine and go 83.3 miles." + "\n"
            ;
