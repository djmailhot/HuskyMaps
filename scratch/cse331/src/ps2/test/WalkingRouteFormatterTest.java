...
public class WalkingRouteFormatterTest extends TestCase {
    ...
    public void testShortDirections() throws IOException {
        ...
        assertEquals("Turn left onto Penny Lane and walk for 93 minutes.\n",
                     mDirections.computeDirections(mShortRoute, 180));
        assertEquals("Turn right onto Penny Lane and walk for 93 minutes.\n",
                     mDirections.computeDirections(mShortRoute, 0));

        assertEquals("Turn slight left onto Penny Lane and walk for 93 minutes.\n",
                     mDirections.computeDirections(mShortRoute, 100));
        assertEquals("Turn slight right onto Penny Lane and walk for 93 minutes.\n",
                     mDirections.computeDirections(mShortRoute, 80));

        assertEquals("Continue onto Penny Lane and walk for 93 minutes.\n",
        ...
        assertEquals("Turn sharp right onto Penny Lane and walk for 93 minutes.\n",
                     mDirections.computeDirections(mShortRoute, 300));
        assertEquals("Turn sharp left onto Penny Lane and walk for 93 minutes.\n",
                     mDirections.computeDirections(mShortRoute, 231));

        assertEquals("U-turn onto Penny Lane and walk for 93 minutes.\n",
    ...
    public void testRepeatedSegment() {
        ...
        assertEquals("Turn left onto Penny Lane and walk for 186 minutes.\n",
    ...
    public void testLongRoute() {
        ...
        route = route.addSegment(new GeoSegment("Yellow Submarine",
                                                ...
                                                new GeoPoint(0,0)));
        String directions =
            "Turn left onto Penny Lane and walk for 186 minutes." + "\n" +
            "Turn left onto Abby Road and walk for 276 minutes." + "\n" +
            "Continue onto Strawberry Fields and walk for 276 minutes." + "\n" +
            "Turn right onto Octopus's Garden and walk for 186 minutes." + "\n" +
            "Turn slight left onto Norwegian Wood and walk for 999 minutes." + "\n" +
            "U-turn onto Yellow Submarine and walk for 1666 minutes." + "\n"
            ;
    ...
    public void testRepeatedRoute() {
        ...
        String directions =
            ...
            "Turn left onto Abby Road and walk for 276 minutes." + "\n" +
            "Continue onto Strawberry Fields and walk for 276 minutes." + "\n" +
            "Turn sharp right onto Octopus's Garden and walk for 398 minutes." + "\n" +
            "Turn slight left onto Norwegian Wood and walk for 999 minutes." + "\n" +
            "U-turn onto Yellow Submarine and walk for 1666 minutes." + "\n"
            ;
