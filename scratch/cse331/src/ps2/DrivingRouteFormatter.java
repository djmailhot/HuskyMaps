 ...
 * <p>
 * <tt>
 * Turn right onto Baker Street and go 1.2 miles.<br />
 * Turn slight left onto MacGregor Street and go 0.8 miles.<br />
 * Turn sharp right onto Burton street and go 2.3 miles.<br />
 * Continue onto Connor Street and go 1.1 miles.<br />
 * </tt>
 * </p>
 *
 * <p>
    ...
    public String computeLine(GeoFeature geoFeature, double origHeading) {
    	return getTurnString(origHeading, geoFeature.getStartHeading()) + 
				"onto " + geoFeature.getName() + " and go " +
				 formatter.format(geoFeature.getLength()) + " miles.\n";
    }
}
